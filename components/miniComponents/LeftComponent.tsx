...
const items = [
  ...
  {
    title: 'Trigan.org',
    feedback: '"Ikhsan is a talented web frontend engineer with a great grasp of React. I would be happy to work with him again!"',
    client: 'Aaron S.',
    clientTitle: 'Founder & CEO Trigan',
    url: 'https://trigan.org/',
  },
  {
    title: 'Reyade, Manama - Kingdom of Bahrain',
    feedback: '"Excellent job, he really nice man and have a lot of skills"',
    client: 'Development Team',
