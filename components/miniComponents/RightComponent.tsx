    ...
    return (
        <div className='flex justify-center items-center'>
            <div className='pl-[0.2rem] mt-[3rem] sm:mt-[3rem] xl:mt-[4rem] xl:pl-[60rem]'>
                ...
                <div className='bg-white w-[22rem] sm:w-[25rem] lg:w-[40rem] h-[18.5rem] sm:h-[18.5rem] md:h-[18rem] lg:h-[15rem]  rounded-md mb-20'>
                    ...
                    <div>
                        ...
                        <div className="px-6 py-4">
                            ...
                            <div className='flex float-left sm:float-right md:float-right lg:float-right items-center mr-[-2rem] lg:mt-[-2.2rem]'>
